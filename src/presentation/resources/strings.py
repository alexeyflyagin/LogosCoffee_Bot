...
class ADMIN(StrGroup):
    ...
    class ANNOUNCEMENT(StrGroup):
        ...
        class DELETE(StrGroup):
            SUCCESSFUL = "Объявление успешно удалено из архива!"

            WARNING = dedent(f"""\
                ⚠️ {b('Внимание!')} После подтверждения, объявление будет удалено из архива.
                Вы уверены, что хотите удалить {b('объявление #{announcement_id}')}?
            """)
