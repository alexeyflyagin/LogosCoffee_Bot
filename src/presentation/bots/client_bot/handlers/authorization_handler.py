...
from src.data.logoscoffee.exceptions import UnknownError, DatabaseError, InvalidPhoneNumberError
...
async def contact_handler(msg: Message, state: FSMContext):
    ...
    except (InvalidPhoneNumberError, DatabaseError, UnknownError):
