...
from presentation.client_bot.handlers.utils import get_token, invalid_token_error
...
async def other_handler(msg: Message, state: FSMContext):
    ...
    try:
        ...
        await msg.answer(strings.CLIENT__SELECT_ACTION, reply_markup=keyboards.MAIN_KEYBOARD)
    except InvalidToken:
